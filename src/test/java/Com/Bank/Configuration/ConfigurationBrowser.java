...
public class ConfigurationBrowser {public static WebDriver driver;
...
public String inputfile(String key) throws IOException {
	File f=new File(System.getProperty("user.dir")+"\\Configure.properties");
